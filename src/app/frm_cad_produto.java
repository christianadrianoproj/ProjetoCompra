...
import banco.ServicoBancoProduto;
...
public class frm_cad_produto extends javax.swing.JFrame {
    ...
    private int carregaProdutos() {
        int retorno = 0;
        ServicoBancoProduto srvBancoProduto = new ServicoBancoProduto();
        ...
        try {
            ...
            retorno = srvBancoProduto.getAll().size();
            for (Produto p : srvBancoProduto.getAll()) {
